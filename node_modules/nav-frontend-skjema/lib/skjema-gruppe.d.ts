...
export declare type SkjemaGruppeFeilContextProps = {
    feil?: React.ReactNode | boolean;
    feilmeldingId?: string;
};
export declare const SkjemaGruppeFeilContext: React.Context<Partial<SkjemaGruppeFeilContextProps>>;
 ...
 * Fieldset
 */
declare class SkjemaGruppe extends React.Component<SkjemaGruppeProps> {
