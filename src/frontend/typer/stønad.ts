export const StønadType = {
  OVERGANGSSTØNAD: 'OVERGANGSSTØNAD',
  BARNETILSYN: 'BARNETILSYN',
  SKOLEPENGER: 'SKOLEPENGER',
} as const;

export type StønadType = (typeof StønadType)[keyof typeof StønadType];
...
export type DokumentType = (typeof DokumentType)[keyof typeof DokumentType];
...
export const dokumentTyperOvergangsstønad: DokumentType[] = [
  ...
  DokumentType.MELDT_ADRESSEENDRING,
  DokumentType.ANNET,
];
